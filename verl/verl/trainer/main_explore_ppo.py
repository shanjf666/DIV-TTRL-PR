...
"""
Entry point for the Two-Stage Exploration PPO Trainer.
Instantiates RayExplorePPOTrainer instead of RayPPOTrainer.
"""
...
from verl.trainer.ppo.explore_ray_trainer import RayExplorePPOTrainer
...
def main(config):
    run_explore_ppo(config)


def run_explore_ppo(config) -> None:
...
class TaskRunner:
    def run(self, config):
        ...
        # Import from explore_ray_trainer instead of ray_trainer
        from verl.trainer.ppo.explore_ray_trainer import RayExplorePPOTrainer
        ...
        # Use RayExplorePPOTrainer instead of RayPPOTrainer
        trainer = RayExplorePPOTrainer(
            config=config,
            tokenizer=tokenizer,
            processor=processor,
